      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="relative bg-white rounded-[2.5rem] shadow-2xl shadow-blue-900/5 border border-slate-100 overflow-hidden">
          ...
          <div className="p-8 md:p-16 text-center">
            ...
            <div className="bg-slate-50 rounded-xl inline-block p-4 mb-6 shadow-inner border border-slate-100">
              <Countdown />
            </div>

            <div className="mb-8 font-sans">
              <span className="text-gray-400 line-through text-2xl mr-4 decoration-2">Prezzo pieno: {HERO_DATA.priceFull}</span>
            ...
            <div className="bg-slate-50 rounded-3xl p-6 md:p-8 max-w-2xl mx-auto border border-slate-200">
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-gray-600 leading-relaxed font-sans max-w-lg">
